...
public class CajeroPro{
	...
	do{
		...
		usuario = scan.next();
		System.out.println("-------------------------------------------------");
		System.out.println("|	         NGRESE SU CONTRASENA		|");
		System.out.println("-------------------------------------------------");
		contrasenia = scan.next();
		scan.nextLine();

		if(usuario.equals("Kristopher") && contrasenia.equals("kris123")){
			System.out.println("Bienvenido Kristopher a su cuenta");
